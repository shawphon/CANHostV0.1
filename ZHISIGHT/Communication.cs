...
namespace ZINSIGHT
{
    public partial class CommunicationForm : Form
    {
        ...
        private void Form1_Load_1(object sender, EventArgs e)
        {
            ...
            curIndex = cobDevType.Items.Add("ZLGVCI_USBCAN-I");
            arrDevType[curIndex] = 3;
            curIndex = cobDevType.Items.Add("ZLGVCI_USBCAN-II");
            arrDevType[curIndex] = 4;
            curIndex = cobDevType.Items.Add("ZLGUSBCAN-E-U");
            arrDevType[curIndex] = 20;
            curIndex = cobDevType.Items.Add("ZLGUSBCAN-2E-U");
            arrDevType[curIndex] = 21;
